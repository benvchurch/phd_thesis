...
\par 
Suppose we have a choose an extension $K_{\alpha} / K$ killing the obstruction $\ob(\alpha) \in \Br(K)[2]$. 

{\color{red} TODO STEINER COMPLEXES}

\todo{computational trick: use bitangents}
